        ...
        <div className='space-y-4'>
            ...
            <div className='mt-6'>
                <textarea
                    ...
                    placeholder='Write a compeeling professionl summary that hightlight your keystrangs'
                />
                <p className='text-xs text-gray-500 max-w-4/5 mx-auto text-center'>
                    Tip: Keep concise (3-4 sentences) and focus on your most relevent achievements and skills
                </p>
            </div>
        </div>
    )
