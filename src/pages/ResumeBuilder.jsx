...
const ResumeBuilder = () => {
    ...
    const loadExistingResume = async () => {
        try {
            ...
            toast.error(error.respone.message || error.message)
        }
    ...
    const saveResume = async () => {
        try {
            ...
            console.log('erorr save cv', error.message)
        }
    }
            ...
            <div className='max-w-7xl mx-auto px-4 pb-8'>
                <div className='grid lg:grid-cols-12 gap-8'>
                    ...
                    <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
                        <div className='bg-white rounded-lg shadow-sm bordr border-gray-200 p-6 pt-1'>
                            {/* Prgress bar using activeSectionIndex */}
                            ...
                            <div className='flex justify-between items-center mb-6 border-b border-gray-300 py-1'>
                                ...
                                <div className='flex items-center'>
                                    {activeSectionIndex !== 0 && (
                                        ...
                                        >
                                            <ChevronLeft className='size-4' /> Pevious
                                        </button>
                    ...
                    <div className='lg:col-span-7 max-lg:mt-6'>
                        <div className='relative w-full'>
                            <div className='absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2'>
                                ...
                                <button
                                    onClick={chnageResumeVisibility}
                                    className='flex items-center p-2 px-4 gap-4 text-xs bg-gradient-to-br from-purple-100 to-purple-200 text-purple-600 ring-purple-300 rounded-lg hover:ring transition-colors'>
                                ...
                                <button
                                    ...
                                    className='flex items-center p-2 px-4 gap-4 text-xs bg-gradient-to-br from-green-100 to-green-200 text-green-600 ring-green-300 rounded-lg hover:ring transition-colors'>
