...
const TemplateSelector = ({ selectedTemplate, onChange }) => {
    ...
    const templates = [
        ...
        },
        {
            id: "minimal",
            name: "Minimal",
            preview: "Simple, elegant, and clean layout focused on readability and spacing."
        },
        {
            id: "minimal-image",
            name: "Minimal Image",
            preview: "Minimalist layout enhanced with a professional profile image for a polished look."
        }
    ];
    return (
